...
var Demo = (function (_super) {
    ...
    function Demo() {
        ...
        BC.addOnceEvent(_this, _this.dispatchSprite, egret.Event.ENTER_FRAME, _this.onEnterFrameOnce);
        //创建和监听一个Timer事件
        var timer = new egret.Timer(50);
        BC.addEvent(_this, timer, egret.TimerEvent.TIMER, _this.onEnterTimer);
        timer.start();
        return _this;
    }
    /**

...
(function (EffectUtils) {
    ...
    */
    function playEffect(obj, cartoonType) {
        ...
        if (cartoonType == 4)
            egret.Tween.get(obj).to({ scaleX: 0.8, scaleY: 0.6, x: obj.x + obj.width * 0.1, y: obj.y + obj.height * 0.4 }, 100, egret.Ease.sineIn).call(onComplete1, this);
        else
